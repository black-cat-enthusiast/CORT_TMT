...
This bookdown project contains raw data, data analyses, and code to generate analyses for the paper \textbf{\emph{Corticosterone regulates the balance between freezing and rearing in defensive responses to predator threat}} published in \emph{Progress in Neuro-Psychopharmacology and Biological Psychiatry} (2025)
...
\includegraphics[width=0.75\linewidth]{Figs/1_TMT_Frz}
...
\includegraphics[width=0.75\linewidth]{Figs/2_Basal_before_after}
...
\includegraphics[width=0.75\linewidth]{Figs/3_30_min_TMT}
...
\includegraphics[width=0.75\linewidth]{Figs/4_30_min_mice_second_TMT}
...
\includegraphics[width=0.75\linewidth]{Figs/5_mimic_panel}
